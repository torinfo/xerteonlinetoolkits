	...
	var RECYCLE_EDIT = "You cannot edit projects in the recycle bin. Please remove the project from the recycle bin before editing";
	...
	var RECYCLE_PROPERTIES = "You cannot set the properties on a file in the recycle bin, please remove this project before continuing";

	var DELETE_ERROR = "Error while trying to delete project";
	...
	var DUPLICATE_PROMPT_OTHER = "Please select a project you would like to duplicate";

	var DUPLICATE_LIMIT = "Only 1 project can be duplicated at any time.";

	var DUPLICATE_ERROR = "Error while duplicating : ";

	var PUBLISH_LIMIT = "Only 1 project can be published at any time";

	var PUBLISH_SUCCESS = "Your project has been published";
	...
	var ERROR_DELETE = "Error while trying to delete project";
