...
$_SESSION["layout"] = $_SESSION["layout"]?? "new";
    ...
    if (($_POST["login"] == $xerte_toolkits_site->admin_username) && ($_POST["password"] == $xerte_toolkits_site->admin_password)) {
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <link href="<?php echo "website_code/styles/management_" . $_SESSION['layout'] . ".css";  ?>" media="screen" type="text/css" rel="stylesheet" id="layout_css" />
                <link rel="stylesheet" type="text/css" href="modules/xerte/parent_templates/Nottingham/common_html5/font-awesome-4.3.0/css/font-awesome.min.css">
                ...
                <script type="text/javascript">
        <?PHP
		echo "var site_layout = \"" . $_SESSION['layout'] . "\";" . PHP_EOL;
        echo "var site_url = \"" . $xerte_toolkits_site->site_url . "\";\n";
        ...
        ?></script>
            ...
            <body onload="javascript:site_list()">
				...
				<?php
				$result = include './website_code/php/management/layout/' . $_SESSION['layout'] . '.php';
				if($result === false){
