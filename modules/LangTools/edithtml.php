...
function output_editor_code($row_edit, $xerte_toolkits_site, $read_status, $version_control){
    ...
    _load_language_file("/modules/langTools/edit.inc");
    ...
    if (file_exists($theme_folder))
    {
		...
		array_unshift($ThemeList, array('name' => "default", 'display_name' => "Default", 'description' => "Default", 'preview' => $xerte_toolkits_site->site_url . "modules/langTools/parent_templates/langTools/common/img/default.jpg"));
    }
	/**
...
<head>
    ...
    <title><?php echo LANGTOOLS_EDIT_TITLE ?></title>
