...
function x_changePage(x_gotoPage, addHistory) {
	...
	// standalone page opening in lightbox
		...
		debugger
		$.featherlight({iframe: window.location.href.split('#')[0] + '#' + pageHash, iframeWidth: $x_mainHolder.width()*0.8, iframeHeight: $x_mainHolder.height()*0.8}, {openTrigger: function(event){
				console.log("trigger");
			}});
