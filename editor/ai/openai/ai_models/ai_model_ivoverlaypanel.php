...
$payload = [
    ...
    "thread" => [
        "messages" => [
            ...
            ["role" => "user", "content" => LEARNING_RESULT_IVOVERLAYPANEL], //The assistant endpoint doesn't support anyone other than 'user' as the author of the message. As a workaround, ensure that 'Assistant:' is appended to the learning result itself.
            ["role" => "user", "content" => ""]
        ],
    ],
