...
$payload = [
    ...
    "thread" => [
        "messages" => [
            ["role" => "user", "content" => LEARNING_PROMPT_FLASHCARDS],
            ["role" => "assistant", "content" => LEARNING_RESULT_FLASHCARDS],
            ["role" => "user", "content" => ""]
        ],
    ],
...
$openAI_preset_models->type_list["flashCards"]["payload"] = $payload;
