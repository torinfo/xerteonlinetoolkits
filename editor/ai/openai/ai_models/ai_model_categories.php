...
$payload = [
    ...
    "thread" => [
        "messages" => [
            ["role" => "user", "content" => LEARNING_PROMPT_CATEGORIES],
            ["role" => "assistant", "content" => LEARNING_RESULT_CATEGORIES],
            ["role" => "user", "content" => ""]
        ],
    ],
...
$openAI_preset_models->type_list["categories"]["payload"] = $payload;
