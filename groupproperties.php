...
<title><?PHP echo GROUPPROPERTIES_TITLE; ?></title>
...
_include_javascript_file("website_code/scripts/groupproperties_tab.js");
...
<body onload="javascript:groupproperties();tab_highlight('1');">
<div class="properties_main">
		<div class="main_area">
				<div>
						<span id="title">
								<img src="website_code/images/Icon_Shared.gif" style="vertical-align:middle; padding-left:10px;" />
								<?PHP echo GROUPPROPERTIES_DISPLAY_TITLE; ?>
						</span>
				</div>
				<div id="data_area">
								...
								<div id="menu_tabs">
										...
										<div id="tab1" class="tab" style="width:146px; height:38px;">
												<p onclick="javascript:tab_highlight('1');groupproperties()">
														<?PHP echo "<i class=\"fa fa-folder\"></i>&nbsp;".GROUPPROPERTIES_TAB_GROUP; ?>
												</p>									
										</div>
										...
										<div id="tab2" class="tab" style="width:146px; height:38px;">
												<p onclick="javascript:tab_highlight('2'); group_content()">
														<?PHP echo "<i class=\"fa fa-folder-open\"></i>&nbsp;".GROUPPROPERTIES_TAB_CONTENT; ?>
												</p>									
										</div>
                                        ...
                                        <div id="tab3" class="tab"  style="width:146px; height:38px;">
                                                <p onclick="javascript:tab_highlight('3'); sharing_status_group()">
                                                    <?PHP echo "<i class=\"fa fa-share\"></i>&nbsp;".GROUPPROPERTIES_TAB_SHARED; ?>
                                                </p>
                                        </div>
