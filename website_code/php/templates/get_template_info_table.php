...
if(has_rights_to_this_template($_POST['template_id'], $_SESSION['toolkits_logon_id']) || is_user_admin()) {
    ...
    $info->properties = project_info_table($_POST['template_id']);
    $info->properties .= media_quota_info_table($_POST['template_id']);
    $info->properties .= access_info_table($_POST['template_id']);
    $info->properties .= rss_syndication_table($_POST['template_id']);

    $info->properties.="</tbody>
            </table>";
