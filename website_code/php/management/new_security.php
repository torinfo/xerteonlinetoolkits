...
if(is_user_admin()){
    ...
    $query = "INSERT INTO {$xerte_toolkits_site->database_table_prefix}play_security_details (security_setting,security_data,security_info) values  (?,?,?)";
    $res = db_query($query, array($_POST['newsecurity'], $_POST['newdata'], $_POST['newdesc']));
