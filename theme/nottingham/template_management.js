 ...
 */
function save_user_preference_apply(key, value, payload, onSuccess) {
...
function save_user_preference_from_response(key, value, response, onSuccess) {
    var r = apiUnpack(response);
    if (r && (r.success === true || (r.preferences && typeof r.preferences === 'object'))) {
        save_user_preference_apply(key, value, r, onSuccess);
        return true;
    }
    return false;
}

function save_user_preference(key, value, onSuccess) {
