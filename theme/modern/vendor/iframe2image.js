...
(function() {
  ...
  window.domvas = {
    ...
    toImage: function(origElem, callback, width, height, left, top) {
      ...
      // Build the SVG containing the cloned XHTML
      var svg =
       ...
       *
       * We use FileReader rather than a blob: URL because SVG foreignObject
       * images loaded through blob: URLs can taint canvases in some browsers.
       */
      ...
      reader.onload = function() {
        ...
        img.onload = function() {
         /* console.log("domvas image loaded", {
            width: this.width,
            height: this.height
          });*/
        ...
        img.onerror = function(event) {
          //console.error("domvas image failed to load", event);
        };
      ...
      reader.onerror = function(event) {
        //console.error("domvas SVG conversion failed", event);
      };
